...
import kmphttp.internal.and
import kmphttp.internal.idn.Idna
...
class PublicSuffixDatabase internal constructor(
     ...
     *     encoded.
     */
    suspend fun getEffectiveTldPlusOne(domain: String): String? {
        // We use UTF-8 in the list so we need to convert to Unicode.
        val unicodeDomain = Idna.toUnicode(domain)
    ...
    private suspend fun findMatchingRule(domainLabels: List<String>): List<String> {
        ...
        if (domainLabelsUtf8Bytes.size > 1) {
            val labelsWithWildcard = domainLabelsUtf8Bytes.copyOf()
            ...
            while (low < high) {
                ...
                if (compareResult < 0) {
                    ...
                    if (labelBytesLeft < publicSuffixBytesLeft) {
                        ...
                        // Found a match.
                        match = this.substring(mid, mid + publicSuffixLength).utf8()
                        break
                    }
                }
            }
